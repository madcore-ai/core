...
# copy CA certificate
scp -i /home/ubuntu/.ssh/id_rsa -o StrictHostKeychecking=no ubuntu@$KUB_MASTER_IP:/opt/kubernetes/ssl/ca.pem /opt/kubernetes/ssl
scp -i /home/ubuntu/.ssh/id_rsa -o StrictHostKeychecking=no ubuntu@$KUB_MASTER_IP:/opt/kubernetes/ssl/ca-key.pem /opt/kubernetes/ssl
