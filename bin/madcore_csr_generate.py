...
if check == "1":
    ...
    config_template = open('/opt/madcore/bin/templates/openssl.conf').read()
    template = Template(config_template)
    config = (template.render(OrganizationName=owner_info['OrganizationName'],
                              OrganizationalUnitName=owner_info['OrganizationalUnitName'], Email=owner_info['Email'],
                              LocalityName=owner_info['LocalityName'], Hostname=owner_info['Hostname'],
                              Country=owner_info['Country'], apps=apps_string))
